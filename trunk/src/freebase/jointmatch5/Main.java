...
public class Main {
	static String dir = "/projects/pardosa/s5/clzhang/ontologylink/jointmatch5";
	...
	static String dir_wikisection = "/projects/pardosa/s5/clzhang/ontologylink/jointmatch5/wikisection";
	static {
	...
	//static String dir_gnid_mid_wid_title_luceneindex = Main.file_gnid_mid_wid_title + ".luceneindex";
	...
	static final String file_sql2instance_mergerel = dir + "/sql2instance_merge";
	...
	public static void main(String[] args) throws Exception {
		...
		S4X_variable_relationmatch.main(null);
		S6X.main(null);
