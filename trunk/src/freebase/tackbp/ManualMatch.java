...
public class ManualMatch {
	...
	static String[] mappedrelation;

	static String file_targetrelation;

	static void match(String file, String[] fbrelations) throws IOException {
		file_targetrelation = file;
		mappedrelation = fbrelations;
		step1();
		step2();
	}
	...
	static void step2() throws IOException {
		{
			...
			}
			{
				...
				while ((l = dr.read()) != null) {
					...
					if (!avoidduplicate.contains(mid1 + "\t" + mid2) && info1 != null && info2 != null && !mid1.equals(mid2)) {
	...
	public static void main(String[] args) throws IOException {
		...
		match(Main.dir + "/spouse",
				new String[] { "/people/person/spouse_s|/people/marriage/spouse" });
		match(Main.dir + "/hasEmployer",
				new String[] { "/people/person/employment_history|/business/employment_tenure/company" });
		match(Main.dir + "/employerHasTitle",
				new String[] { "/people/person/employment_history|/business/employment_tenure/title" });
	}
