...
public class HackMemberOf {
	...
	static String[] mappedrelation = new String[] {
			...
			"/soccer/football_player/current_team|/soccer/football_roster_position/team",
			"/ice_hockey/hockey_player/current_team|/ice_hockey/hockey_roster_position/team",
			"/american_football/football_player/current_team|/american_football/football_roster_position/team",
			"/basketball/basketball_player/team|/basketball/basketball_roster_position/team",
			"/music/group_member/membership|/music/group_membership/group" };

	static String file_targetrelation = Main.dir + "/memberof";
