...
public class Main {
	static String dir = "/projects/pardosa/s5/clzhang/ontologylink/jointmatch10";
	...
	static void convertInfobox2Nell() throws IOException {
		...
		{
			List<String[]> all1 = (new DelimitedReader(dir+"/relation_class")).readAll();
			List<String[]> all2 = (new DelimitedReader(dir+"/seed_instance")).readAll();
			for (String[] a : all1) {
		...
		}
		{
			...
			for (Entry<String, String[]> e : relation2everything.entrySet()) {
				String []l = e.getValue();
				dw.write(l[0],"TRUE","",l[1],l[2],"FALSE","FALSE","FALSE","","","",l[3],"","");
			}
			dw.close();
		}
	}
	...
	public static void main(String[] args) throws Exception {
		//convertInfobox2Nell();
		//no= new NellOntology(Main.file_ontology);
