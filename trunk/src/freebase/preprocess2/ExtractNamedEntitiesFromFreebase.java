...
public class ExtractNamedEntitiesFromFreebase {
	...
	public static void extract(String freebaseDumpFile, String output, String tmpDir) throws IOException {
		{
			...
			while ((line = r.readLine()) != null) {
				...
				if (c.length > 3) {
					String v2 = c[3];
					if (rel.equals("/type/object/name") || rel.equals("/common/topic/alias"))
