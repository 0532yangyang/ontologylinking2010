...
public class Main {
	static String dir = "/projects/pardosa/s5/clzhang/ontologylink/jointmatch4";
	...
	/**outside input*/
	static String file_raw_ontology_class = dir + "/mycreateontology/relation_class";
	static String file_raw_ontology_seedinstance = dir + "/mycreateontology/seed_instance";
	...
	static String file_seb_guid2name = pdir + "/guid2name";
