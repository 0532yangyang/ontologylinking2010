...
public class NYTCreateProtobufDatasets {
	...
	static String output1 = "/projects/pardosa/s5/clzhang/ontologylink/nyt/featurizedData";
	static String output2 = "/projects/pardosa/s5/clzhang/ontologylink/nyt/featurizedData.pb";
	...
	public static void main(String[] args) throws IOException {
		...
		*/
		...
		//
		// sort by arg1, arg2
		Sort.sort(output1, output1 + ".sorted", Main.dir, new Comparator<String[]>() {
			public int compare(String[] t1, String[] t2) {
				return NYTCreateProtobufDatasets.compare(t1, t2);
			}
		});
		...
		// convert to protobuf
		{
			OutputStream os = new BufferedOutputStream(new FileOutputStream(output2));
