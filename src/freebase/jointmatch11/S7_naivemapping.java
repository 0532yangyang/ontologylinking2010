...
public class S7_naivemapping {
	...
	static String file_debug = Main.file_jointclause + ".naive.debug";
	static String file_weightchange = Main.file_jointclause + ".naive.weight";
	...
	public static void main(String[] args) throws IOException {
		...
		init();
		printVariable(Main.file_jointclause + ".naive.variable");
		printView(Main.file_naiveview);
